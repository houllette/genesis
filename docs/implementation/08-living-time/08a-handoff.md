# Historical handoff: 08A — Local time and completion

This archived delivery record is superseded by [the current handoff](handoff.md).
Its single-place/zero-time guards and remaining slices describe the earlier tree.
08A was subsequently published as `d860d7f`.
